...
public class ApplicationDbContext : IdentityDbContext<ApplicatioUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Doctor>(entity =>
        {
            ...
            entity.Property(d => d.ClinicName).HasMaxLength(150);
            entity.Property(d => d.ContactInfo).HasMaxLength(100);
            entity.Property(d => d.Biography).HasMaxLength(1000);
            entity.Property(d => d.ProfilePhotoUrl).HasMaxLength(500);
            entity.Property(d => d.CreatedAt).IsRequired().HasDefaultValueSql("GETUTCDATE()");
        ...
        builder.Entity<CaregiverPatientLink>(entity =>
        {
            ...
            entity.Property(l => l.CreatedAt).IsRequired().HasDefaultValueSql("GETUTCDATE()");
        ...
        builder.Entity<AuditLog>(entity =>
        {
            ...
            entity.Property(a => a.UserId).IsRequired().HasMaxLength(150);
            entity.Property(a => a.Action).IsRequired().HasMaxLength(100);
            entity.Property(a => a.Details).IsRequired().HasMaxLength(2000);
            entity.Property(a => a.CreatedAt).IsRequired().HasDefaultValueSql("GETUTCDATE()");
        });
