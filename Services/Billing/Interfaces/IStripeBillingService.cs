...
public interface IStripeBillingService
{
    ...
    Task<BillingServiceResult<CheckoutSessionResponse>> CreateDoctorCheckoutSessionAsync(Guid doctorId, CreateSubscriptionCheckoutRequest request, CancellationToken cancellationToken = default);
    Task<BillingServiceResult<bool>> VerifyDoctorCheckoutSessionAsync(Guid doctorId, string sessionId, CancellationToken cancellationToken = default);
    ...
    Task<bool> HasDoctorPremiumAccessAsync(Guid doctorId, CancellationToken cancellationToken = default);
}
